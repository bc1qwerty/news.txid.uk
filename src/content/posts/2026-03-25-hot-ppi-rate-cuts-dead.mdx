...
| FOMC Projection | December 2025 | March 2026 | Shift |
|---|---|---|---|
| Median year-end rate | 3.15% (two cuts) | 3.4% (one cut) | Hawkish |
| Core PCE forecast | 2.5% | 2.7% | Upward |
| Members expecting 2+ cuts | Majority | Minority | Fewer doves |

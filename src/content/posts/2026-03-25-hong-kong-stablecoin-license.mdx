...
| Jurisdiction | Reserve Standard | Key Advantage | Key Limitation |
|---|---|---|---|
| Hong Kong | HQLA only | Strictest reserves, institutional credibility | Smaller market, China relationship uncertainty |
| Singapore | Principles-based | Flexibility, fintech ecosystem | Less prescriptive reserves |
| Dubai | Sandbox-based | Speed, regulatory flexibility | Credibility concerns |
| EU (MiCA) | Cash + low-risk assets | Largest geographic scope | Compliance costs |
| United States | No federal framework | Largest market | Regulatory fragmentation |

---
title: "Square's Default-On Lightning: The Biggest Bitcoin Payments Milestone Since El Salvador"
date: "2026-03-23"
category: "bitcoin"
tags: ["bitcoin", "lightning network", "square", "block", "payments", "merchant adoption"]
summary: "Starting March 30, Block's Square will enable Bitcoin Lightning payments by default across 4 million merchants worldwide. Zero fees through 2026, instant settlement, no chargebacks. This is the largest single merchant onboarding event in Lightning Network history."
author: "txid"
---
...
1. **Auto-convert to local currency (USD, GBP, etc.)** — they never touch Bitcoin
2. **Keep it in BTC** — hold it on their Square balance
3. **Turn it off entirely** — opt out
...
- **Cash App**: peer-to-peer Bitcoin buying and sending for 50+ million users
- **Bitkey**: a self-custody Bitcoin hardware wallet available in 95+ countries
- **Spiral**: an open-source Bitcoin development initiative funding Lightning and Bitcoin Core contributors
- **TBD**: decentralized identity and Bitcoin-native financial infrastructure
...
- **Blockstream Jade** became the first hardware wallet to support Lightning payments (March 12, 2026), using atomic swaps through the Liquid sidechain
- **Boltz Exchange** launched non-custodial USDT-to-Lightning atomic swaps (March 18, 2026)
- **Voltage** introduced USD-settled revolving credit lines on Lightning (February 2026), allowing businesses to use Lightning speed without holding BTC
- **Tether USDT** went live on Lightning via Taproot Assets, bringing stablecoin liquidity to the network

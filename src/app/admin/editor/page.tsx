      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="px-4 py-2 rounded-lg border border-neutral-300 dark:border-border text-sm font-medium text-neutral-500 hover:text-neutral-700 dark:hover:text-neutral-200 transition"
          >
            Cancel
          </button>
          <button
